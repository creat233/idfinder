      ...
      <div className="container mx-auto py-12">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <Card className="p-6 text-center">
            ...
            <p className="text-gray-600">
              2000 Fr de récompense pour chaque carte restituée
            </p>
          </Card>
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-gray-600 mb-6">
            Depuis notre création, nous avons déjà permis la restitution de nombreuses pièces d'identité et distribué plus de 150'000 Fr de récompenses à nos utilisateurs.
          </p>
        </div>
      </div>
    </div>
