-- Supprimer la contrainte et le trigger problématiques
ALTER TABLE notifications DROP CONSTRAINT IF EXISTS notifications_card_id_fkey;
DROP TRIGGER IF EXISTS trigger_notify_favorites_on_product_added ON mcard_products CASCADE;
DROP FUNCTION IF EXISTS notify_favorites_on_product_added() CASCADE;
