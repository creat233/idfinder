  ...
  return (
    <AbsoluteFill style={{ fontFamily, justifyContent: "center", alignItems: "center", padding: 80 }}>
      ...
      <h2 style={{
        ...
        Finder ID aujourd'hui !
      </h2>

      <div style={{
        width: interpolate(frame, [20, 50], [0, 300], { extrapolateRight: "clamp", extrapolateLeft: "clamp" }),
        height: 3, background: "linear-gradient(90deg, transparent, #8B5CF6, transparent)",
      ...
      <p style={{
        ...
        Protégez vos documents • Boostez votre business
      </p>
      ...
      <div style={{
        ...
        background: "linear-gradient(135deg, #8B5CF6, #EC4899)",
        borderRadius: 30, padding: "24px 60px",
      ...
      <p style={{
        fontSize: 28, color: "rgba(255,255,255,0.5)", fontWeight: 600, marginTop: 40,
